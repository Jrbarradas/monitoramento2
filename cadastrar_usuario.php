...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $estado_permitido = $is_admin ? trim($_POST['estado_permitido']) : $estado_usuario;
    ...
    if (empty($erros)) {
        try {
            ...
            if ($stmt->rowCount() > 0) {
                ...
                $stmt = $pdo->prepare("INSERT INTO usuarios (username, password, nome_completo, nivel_acesso, estado_permitido) VALUES (?, ?, ?, ?, ?)");
                $stmt->execute([$username, $password_hash, $nome_completo, $nivel_acesso, $estado_permitido]);
                
                $mensagem = '<div class="mensagem sucesso">Usuário cadastrado com sucesso!</div>';
...
<head>
    <meta charset="UTF-8">
    <title>Cadastrar Usuário - Spacecom</title>
    ...
    <div class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-subtitle">Preencha os dados do novo usuário</div>
            </div>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nome_completo" name="nome_completo" value="<?= isset($nome_completo) ? htmlspecialchars($nome_completo) : '' ?>" required>
                </div>
                ...
                <?php else: ?>
                    <input type="hidden" name="estado_permitido" value="<?= $estado_usuario ?>">
                <?php endif; ?>
