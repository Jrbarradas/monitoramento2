...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Converter para UTC antes da consulta
    ...
    $dataInicioObj->setTimezone(new DateTimeZone('UTC'));
    $dataFimObj->setTimezone(new DateTimeZone('UTC'));
    ...
    if (strtotime($dataFimMySQL) < strtotime($dataInicioMySQL)) {
        ...
        $sql = "SELECT 
                    ...
                    l.nome, 
                    l.ip, 
                    DATE_FORMAT(CONVERT_TZ(hs.checked_at, '+00:00', '-03:00'), '%d/%m/%Y %H:%i') AS data_formatada,
                    CONVERT_TZ(hs.checked_at, '+00:00', '-03:00') AS checked_at_local
